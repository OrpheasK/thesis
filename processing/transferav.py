...
def predict_song(m, fname, seq_len=1024):
...
for directory, subdirectories, files in os.walk('C:/Users/Papias/Desktop/thesis/copy/midi/Rock_Cleansed/3'):
	for file in files:
		midifile = os.path.abspath(os.path.join(directory, file))
		pred = predict_song(m,midifile)
		sumpr+=pred[4]# Rock 0, Tetr 1, Jazz 4
		i+=1
		#print('fa')

print("Average:\t{:.2f}%".format((sumpr/i)*100))
